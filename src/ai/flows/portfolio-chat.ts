...
const portfolioChatPrompt = ai.definePrompt({
  ...
  Be concise and professional. If the answer is not in the knowledge base, say "I can only answer questions about Rohith's portfolio. Please ask me about his skills, projects, or experience."
