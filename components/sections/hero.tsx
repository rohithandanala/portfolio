        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 lg:gap-16 items-center">
          ...
          <div className="md:col-span-3 flex flex-col justify-center space-y-6 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start animate-fade-in duration-500 [animation-delay:400ms]">
              <Button asChild size="lg" className="group w-full sm:w-fit border-primary hover:bg-destructive hover:border-destructive hover:text-destructive-foreground" variant="outline">
                ...
                <div key={index} className="animate-slide-up duration-400" style={{ animationDelay: `${500 + index * 100}ms` }}>
                  <Card className="bg-card/80 backdrop-blur-sm border-primary/50 hover:border-primary/50 hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/10 transition-all duration-300 h-full">
                    <CardHeader className="p-4">
                      <CardTitle className="text-destructive text-2xl font-bold font-headline">{card.title}</CardTitle>
                    </CardHeader>
