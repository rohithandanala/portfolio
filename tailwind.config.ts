  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'jelly-border': {
          '0%, 100%': { 'border-radius': 'calc(var(--radius) + 6px) calc(var(--radius) - 6px) calc(var(--radius) + 8px) calc(var(--radius) - 8px)' },
          '25%': { 'border-radius': 'calc(var(--radius) - 8px) calc(var(--radius) + 8px) calc(var(--radius) - 6px) calc(var(--radius) + 6px)' },
          '50%': { 'border-radius': 'calc(var(--radius) + 6px) calc(var(--radius) - 6px) calc(var(--radius) - 8px) calc(var(--radius) + 8px)' },
          '75%': { 'border-radius': 'calc(var(--radius) - 8px) calc(var(--radius) + 8px) calc(var(--radius) + 6px) calc(var(--radius) - 6px)' },
        },
        'pulse-subtle': {
        ...
        'slide-in-from-left': { from: { transform: 'translateX(-100px)', opacity: '0' }, to: { transform: 'translateX(0)', opacity: '1' } },
      ...
      animation: {
        ...
        'rotating-border': 'rotating-border 3s linear infinite',
